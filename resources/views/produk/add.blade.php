...
<div class="card-body">
        ...
        <div id="pay-invoice">
            <div class="card-body">
                ...
                <hr>
                <form action="{{url('produk/addp')}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="cc-payment" class="control-label mb-1">Kode Produk</label>
                        <input id="kode" name="kode" type="text" class="form-control" placeholder="Masukkan Kode Produk">
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="berat" name="berat" class="form-control" placeholder="- -  - kg">
                            <span class="help-block" data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
                        </div>
                        <div class="form-group">
